...
import com.padc.bannerslider.ss.com.bannerslider.adapters.PositionController;
import com.padc.bannerslider.ss.com.bannerslider.adapters.SliderAdapter;
import com.padc.bannerslider.ss.com.bannerslider.adapters.SliderRecyclerViewAdapter;
import com.padc.bannerslider.ss.com.bannerslider.event.OnSlideChangeListener;
import com.padc.bannerslider.ss.com.bannerslider.event.OnSlideClickListener;
...
public class Slider extends FrameLayout {
        ...
        if (attributeSet != null) {
            ...
            try {
                config = new Config.Builder(getContext())
                        ...
                        .indicatorBackGroundColor(typedArray.getColor(R.styleable.Slider_indicator_background, Color.TRANSPARENT))
                        .build();
            } catch (Exception e) {
    ...
    private void setupSlideIndicator() {
        if (!config.hideIndicators) {
            slideIndicatorsGroup = new SlideIndicatorsGroup(getContext(),
                    ...
                    config.indicatorBackGroundColor);
        }
    }
    ...
    private void refreshIndicators() {
        if (!config.hideIndicators && sliderAdapter != null) {
            ...
            slideIndicatorsGroup = new SlideIndicatorsGroup(getContext(), config.selectedSlideIndicator, config.unselectedSlideIndicator, 0, config.indicatorSize, config.animateIndicators,config.indicatorBackGroundColor);
            addView(slideIndicatorsGroup);
